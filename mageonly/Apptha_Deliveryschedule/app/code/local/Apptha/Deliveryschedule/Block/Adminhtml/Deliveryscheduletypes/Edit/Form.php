 ...
 *
 * */
class Apptha_Deliveryschedule_Block_Adminhtml_Deliveryscheduletypes_Edit_Form extends Mage_Adminhtml_Block_Widget_Form {
    /**
    ...
    protected function _prepareForm() {
        ...
        $this->setForm ( $form );
        /**
         * return prepared form action for add or edit form
         */ 
