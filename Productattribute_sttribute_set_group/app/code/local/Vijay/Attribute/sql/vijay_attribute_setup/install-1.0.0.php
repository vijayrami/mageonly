...
$installer->addAttributeGroup('catalog_product', 'Default', 'Test Group', 20000);

// addAttribute uses _prepareValues()
$data = array (
		'label' => 'My Options Values',
...
$installer->addAttribute ( 'catalog_product', 'vijay_insalled_attribute', $data );
$installer->addAttribute ( 'catalog_product', 'owner_id', $data1 );
// Done:
$installer->endSetup ();