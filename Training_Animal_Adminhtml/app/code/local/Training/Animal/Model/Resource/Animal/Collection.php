 ...
 */
/**
 * Animal collection resource model
 *
 * @category    Training
 * @package     Training_Animal
...
class Training_Animal_Model_Resource_Animal_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
     ...
     * @return Training_Animal_Model_Resource_Animal_Collection
     * @author Ultimate Module Creator
     */
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                array('store_table' => $this->getTable('training_animal/animal_store')),
                'main_table.entity_id = store_table.animal_id',
                array()
            )
